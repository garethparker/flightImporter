...
# 00003 25/10/2012 G.Parker  Added check to create fresh DB if none exists
#=============================================================================
...
def dbcheck():
    ...
    conn=sqlite3.connect(DBFileLocation)
    c=conn.cursor()
    c.execute('CREATE TABLE IF NOT EXISTS "data" ("data_id" INTEGER PRIMARY KEY AUTOINCREMENT,"callsign" TEXT,"hex" TEXT,"lon" TEXT,"lat" TEXT,"track" TEXT,"altitude" TEXT,"speed" TEXT,"squark" TEXT,"radar" TEXT,"aircraft" TEXT,"reg" TEXT,"time_stamp" TEXT,"dept_airport" TEXT,"dest_airport" TEXT)')
    conn.commit()
    c.close()
...
try:
   with open(databaseLocation) as f: pass
	...
	dbcheck()
	print('Could not find database: ' + DBFileLocation + '. New Database created.')
